...
for (let member of team) {
  document.getElementById("team-list").innerHTML += `<div class="card project">
    <div class="card--icon" style="background-image: url('${member.pfp}')"></div>
    <span class="card--name">${member.name}</span>
    <span class="card--subname">${member.roles.join("&ensp;&bull;&ensp;")}</span>
  </div>`
}